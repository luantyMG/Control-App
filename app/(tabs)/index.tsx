  ...
  return (
    <TabsLayoutWrapper>
      <ScrollView contentContainerStyle={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <CardButtonGrid>
          <CardButton iconName="clock" textCard="Horarios" onPress={() => {}} />
          <CardButton iconName="alert-octagon" textCard="Buzón de Quejas o Sugerencias" onPress={() => {}} />
          <CardButton iconName="codesandbox" textCard="Academia" onPress={() => {}} />
          <CardButton iconName="award" textCard="Calificaciones" onPress={() => {}} />
          <CardButton iconName="settings" textCard="Configuración" onPress={() => {}} />
        </CardButtonGrid>
      </ScrollView>
    </TabsLayoutWrapper>
  );
